...
- [`BAFS2022_framing_pub.csv`](https://github.com/michaelschulte/web20/blob/main/0_data/BAFS2022_framing_pub.csv): one row per participant and framing task, with the `condition`, the `frame` the task was shown in, the `rating` given, the response `duration` and the participant's numeracy `score` and `numeracy` group.
- [`BAFS2022_numeracy_pub.csv`](https://github.com/michaelschulte/web20/blob/main/0_data/BAFS2022_numeracy_pub.csv): one row per participant, with the numeracy `score` and the `numeracy` group derived from it.
- [`BAFS2022_demographie_pub.csv`](https://github.com/michaelschulte/web20/blob/main/0_data/BAFS2022_demographie_pub.csv): gender and age per participant.
